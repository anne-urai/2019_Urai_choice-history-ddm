...
% PLOT ONLY BAR GRAPH
[rho1, pval1] = corr(results.ddmK_dcz_zbias, results.repetitionK, ...
    'type', 'spearman', 'rows', 'complete');

[rho2, pval2] = corr(results.ddmK_dcz_dcbias, results.repetitionK, ...
    'type', 'spearman', 'rows', 'complete');

% compute the difference in correlation
[rho3, pval3] = corr(results.ddmK_dcz_zbias, results.ddmK_dcz_dcbias, ...
