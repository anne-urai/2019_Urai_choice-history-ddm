...
% ============================================ %
% PLOT ONLY BAR GRAPH
[rho1, pval1] = corr(results.ddmColl_dcz_zbias, results.repetitionK, ...
    'type', 'spearman', 'rows', 'complete');

[rho2, pval2] = corr(results.ddmColl_dcz_dcbias, results.repetitionK, ...
    'type', 'spearman', 'rows', 'complete');

% compute the difference in correlation
[rho3, pval3] = corr(results.ddmColl_dcz_zbias, results.ddmColl_dcz_dcbias, ...
