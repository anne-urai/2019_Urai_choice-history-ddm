...
models = ['stimcoding_nohist', # 19
    ...
    'regress_dc_prevresp_prevstim_vasessions', # 6
    'regress_dc_prevresp_prevstim_vasessions_prevrespsessions', # 7
    'regress_dc_prevresp_prevstim_vasessions_prevpupil', # 8
    'regress_dc_prevresp_prevstim_vasessions_prevrt', # 9
    'regress_dc_prevresp_prevstim_vasessions_prevrt_prevpupil', # 10
    'regress_dc_prev2resp_prev2stim', # 17
    'regress_dc_prev3resp_prev3stim'] # 20
