...
sArray = [
    ...
    {'subj_idx':18, 'v':v, 'dc':dc+0.2, 'z':0.5*a, 'a':a, 'dc_slope':dc_slope, 'sv':sv, 'bound':'collapse_hyperbolic', 'c':3, 'nr_trials':nr_trials},
    {'subj_idx':19, 'v':v, 'dc':dc+0.5, 'z':0.5*a, 'a':a, 'dc_slope':dc_slope, 'sv':sv, 'bound':'collapse_hyperbolic', 'c':3, 'nr_trials':nr_trials},
    {'subj_idx':20, 'v':v, 'dc':dc+0.8, 'z':0.5*a, 'a':a, 'dc_slope':dc_slope, 'sv':sv, 'bound':'collapse_hyperbolic', 'c':3, 'nr_trials':nr_trials},
...
fig = plt.figure()
t = np.arange(0,tmax,dt)
b1, b0 = _bounds_collapse_hyperbolic(a=2, c=3.5, tmax=tmax, dt=dt)
plt.plot(t,b1)
plt.plot(t,b0)
