function b2_HDDM_readIntoMatlab()
  ...
  for d = 1:length(datasets),
    ...
    mdls = {'stimcoding_nohist', ...
        ...
        'regress_dc_prevresp_prevstim_vasessions', ...
        'regress_dc_prevresp_prevstim_prevpupil', ...
        'regress_dc_prevresp_prevstim_prevrt', ...
        'regress_dc_prevresp_prevstim_prevrt_prevpupil', ...
        'regress_dc_z_prevresp_prevstim_vasessions', ...
        'regress_dc_z_prevresp_prevstim_prevpupil', ...
        'regress_dc_z_prevresp_prevstim_prevrt', ...
        'regress_dc_z_prevresp_prevstim_prevrt_prevpupil', ...
        'regress_dc_prevresp_prevstim_vasessions_prevrespsessions', ...
        'regress_dc_prevresp_prevstim_vasessions_prevpupil', ...
        'regress_dc_prevresp_prevstim_vasessions_prevrt', ...
        'regress_dc_prevresp_prevstim_vasessions_prevrt_prevpupil'};
