function alldat = correlationScatter_prev2resp(Gsq, sz)
...
for d = length(datasets):-1:1
    ...
    try
        ...
        results.z_prevresp = ...
            results.(['z_1__' whichmdls 'dczprev2resp']) - results.(['z_2__' whichmdls 'dczprev2resp']);
        results.v_prevresp = ...
            results.(['dc_1__' whichmdls 'dczprev2resp']) - results.(['dc_2__' whichmdls 'dczprev2resp']);
    catch
        results.z_prevresp = ...
            results.(['z_1_0__' whichmdls 'dczprev2resp']) - results.(['z_2_0__' whichmdls 'dczprev2resp']);
        results.v_prevresp = ...
            results.(['dc_1_0__' whichmdls 'dczprev2resp']) - results.(['dc_2_0__' whichmdls 'dczprev2resp']);
    end
    ...
    xlabel(sp1, {'History shift in z'; 'Lag 2'});
    set(sp1, 'xcolor', colors(1, :), 'ycolor', 'k');
    xlabel(sp2, {'History shift in v_{bias}'; 'Lag 2'});
    ...
    tightfig;
    if Gsq,
        print(gcf, '-dpdf', sprintf('~/Data/serialHDDM/figure1c_Gsq_modelfree_stimcoding_sz%d_d%d_prev2resp.pdf', sz, d));
    else
        print(gcf, '-dpdf', sprintf('~/Data/serialHDDM/figure1c_HDDM_modelfree_stimcoding_sz%d_d%d_prev2resp.pdf', sz, d));
