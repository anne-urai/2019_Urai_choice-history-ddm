function alldat = individual_correlation_congruency
...
for d = length(datasets):-1:1
    ...
    z_congruent = results.z_1_1__stimcodingdczprevrespcongruency - results.z_1_2__stimcodingdczprevrespcongruency;
    z_incongruent = results.z_0_1__stimcodingdczprevrespcongruency - results.z_0_2__stimcodingdczprevrespcongruency;

    dc_congruent = results.dc_1_1__stimcodingdczprevrespcongruency - results.dc_1_2__stimcodingdczprevrespcongruency;
    dc_incongruent = results.dc_0_1__stimcodingdczprevrespcongruency - results.dc_0_2__stimcodingdczprevrespcongruency;
    ...
    allresults(1).scattercolor	 	= cols(9, :);
    ...
    allresults(2).scattercolor	 	= cols(7, :);
    ...
    tightfig;
    if Gsq,
        print(gcf, '-dpdf', sprintf('~/Data/serialHDDM/figure1c_Gsq_modelfree_congruency_d%d.pdf', d));
    else
        print(gcf, '-dpdf', sprintf('~/Data/serialHDDM/figure1c_HDDM_modelfree_congruency_d%d.pdf', d));
