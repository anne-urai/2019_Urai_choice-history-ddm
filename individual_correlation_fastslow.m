...
for d = length(datasets):-1:1
    ...
    alltitles{1}                 = cat(2, datasetnames{d}{1}, ' - ', 'Fast');
    ...
    alltitles{2}                 = cat(2, datasetnames{d}{1}, ' - ', 'Slow');
    ...
    if Gsq,
        ...
        print(gcf, '-dpdf', sprintf('~/Data/serialHDDM/figure1c_HDDM_modelfree_fastslow_sz%d_d%d.pdf', d, sz));
